            ...
            <div class="flex flex-col 2xl:flex-row gap-3.5 items-start 2xl:items-center justify-between">
                ...
                <div class="flex flex-wrap items-center gap-2.5 w-full 2xl:w-auto">
                    ...
                    @if(isset($periods) && $periods->isNotEmpty())
                        <select name="period_id" onchange="htmx.trigger(this.form, 'submit')" class="py-2.5 px-3.5 text-xs rounded-xl border border-slate-200 bg-white font-bold text-slate-650 focus:outline-none focus:ring-2 focus:ring-brand-emerald cursor-pointer">
        ...
        <form id="candidate-dispensation-form" onsubmit="submitCandidateDispensationForm(event); return false;" class="p-6 space-y-5">
            ...
            <div class="p-4 rounded-2xl bg-purple-50/70 dark:bg-purple-950/40 border border-purple-150 dark:border-purple-800/60 space-y-2">
                <div class="flex items-center justify-between text-xs font-semibold">
                    ...
                    <span class="font-extrabold text-purple-800 dark:text-purple-300">Tahap Administrasi</span>
                </div>
                <div class="flex items-center justify-between text-xs font-semibold">
            ...
            <div class="space-y-1.5">
                ...
                <textarea 
                    ...
                    rows="3" 
                    required 
                    placeholder="Tuliskan alasan / keterangan dispensasi di sini (contoh: Anak Guru TK, Kebijakan Khusus Yayasan, dll.)..." 
                    class="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition resize-none"></textarea>
            </div>
...
window.exportCandidatesPdf = function(btn) {
    const form = document.getElementById('candidateFilterForm');
    const baseUrl = "{{ route('admin.candidates.export-pdf') }}";
