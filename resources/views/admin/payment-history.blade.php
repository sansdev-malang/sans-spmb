                        ...
                        <tr class="hover:bg-slate-50/55 dark:hover:bg-slate-800/40 transition group">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <button type="button" onclick="copyToClipboard('{{ $pay->invoice_number }}', 'Nomor Invoice disalin')" class="text-slate-350 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition cursor-pointer" title="Salin Invoice">
                                ...
                                <div class="mt-1 flex flex-wrap items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
                                    ...
                                    @if($displayWinpayId)
                                        <div class="flex items-center gap-1">
                                            ...
                                            <button type="button" onclick="copyToClipboard('{{ $displayWinpayId }}', 'ID Transaksi disalin')" class="text-slate-350 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition cursor-pointer" title="Salin ID Transaksi">
                            ...
                            <td class="py-4 px-6">
                                ...
                                @if(is_array($pay->payment_info) && isset($pay->payment_info['virtualAccountNo']))
                                    <div class="mt-1 flex items-center gap-1">
                                        ...
                                        <button type="button" onclick="copyToClipboard('{{ $pay->payment_info['virtualAccountNo'] }}', 'Nomor VA disalin')" class="text-slate-350 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition cursor-pointer" title="Salin Nomor VA">
                                            <i data-lucide="copy" class="w-2.5 h-2.5"></i>
                                        </button>
                                    </div>
                                @endif
