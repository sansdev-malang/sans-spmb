...
<script>
    ...
    function openTransactionsModal(cand, payments, feeDetails) {
        ...
        const finalPayments = successPayments.filter(p => p.payment_type === 'final_fee');
        const regFeePayments = successPayments.filter(p => p.payment_type === 'registration_fee');
        ...
        const componentsToRender = allItemsList.length > 0 
            ...
            : Object.keys(itemTracker).filter(k => {
                ...
                discount_amount: 0,
                net_amount: itemTracker[k].totalPaid
            }));
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                            <div>
                                ...
                                <div class="flex items-center gap-2.5 text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                                    ...
                                    <span>•</span>
                                    <span class="text-emerald-600 dark:text-emerald-400 font-semibold">Terbayar: Rp ${compPaid.toLocaleString('id-ID')}</span>
