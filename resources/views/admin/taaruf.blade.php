                                    ...
                                    @if(!$isCompleted)
                                        ...
                                        @if($isScheduled)
                                            <button type="button" 
                                                ...
                                                class="px-2.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold transition flex items-center gap-1 shadow-sm cursor-pointer" 
                                                title="Selesaikan Ta'aruf">
                                        ...
                                        @if($isScheduled)
                                            <button type="button" 
                                                ...
                                                class="p-1.5 bg-slate-100 hover:bg-rose-50 text-slate-400 hover:text-rose-600 dark:bg-slate-800 dark:hover:bg-rose-950/40 rounded-lg text-xs transition cursor-pointer" 
                                        ...
                                        <div class="inline-flex items-center gap-1.5">
                                            ...
                                            @if($reg->registration_status === 'taaruf_completed')
                                                <button type="button" 
                                                    ...
                                                    class="px-2.5 py-1 bg-amber-500 hover:bg-amber-600 text-white rounded-lg text-[11px] font-bold transition flex items-center gap-1 shadow-xs cursor-pointer" 
